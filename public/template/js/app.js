        ...
        document.getElementById("header-lang-img") &&
            ("en" == e
                ? (document.getElementById("header-lang-img").src =
                      "/template/images/flags/us.jpg")
                : "sp" == e
                ? (document.getElementById("header-lang-img").src =
                      "/template/images/flags/spain.jpg")
                : "gr" == e
                ? (document.getElementById("header-lang-img").src =
                      "/template/images/flags/germany.jpg")
                : "it" == e
                ? (document.getElementById("header-lang-img").src =
                      "/template/images/flags/italy.jpg")
                : "ru" == e &&
                  (document.getElementById("header-lang-img").src =
                      "/template/images/flags/russia.jpg"),
            localStorage.setItem("language", e),
            null == (t = localStorage.getItem("language")) && a(n),
            s.getJSON("/template/lang/" + t + ".json", function (e) {
                s("html").attr("lang", t),
    ...
    function r(e) {
        ...
        "light-mode-switch" === e
            ? (s("html").removeAttr("dir"),
              ...
              s("#app-style").attr("href", "/template/css/app.min.css"),
            ...
            ? (s("html").removeAttr("dir"),
              ...
              s("#bootstrap-style").attr(
                  "href",
                  "/template/css/bootstrap-dark.min.css"
              ),
              s("#app-style").attr("href", "/template/css/app-dark.min.css"),
            ...
            ? (s("#light-mode-switch").prop("checked", !1),
              ...
              s("#app-style").attr("href", "/template/css/app-rtl.min.css"),
              s("html").attr("dir", "rtl"),
            ...
            : 1 == s("#dark-rtl-mode-switch").prop("checked") &&
              ...
              s("#bootstrap-style").attr(
                  "href",
                  "/template/css/bootstrap-dark-rtl.min.css"
              ),
              s("#app-style").attr("href", "/template/css/app-dark-rtl.min.css"),
              s("html").attr("dir", "rtl"),
